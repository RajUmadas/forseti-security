...
class FweRulesEngine(bre.BaseRulesEngine):
    """Rules engine for bucket acls"""
    ...
    def __init__(self, rules_file_path, snapshot_timestamp=None):
        ...
        """
        super(FweRulesEngine, self).__init__(
    ...
    def build_rule_book(self):
        ...
        self.rule_book = FweRuleBook(self._load_rule_definitions())
...
class FweRuleBook(bre.BaseRuleBook):
    ...
    def __init__(self, rule_defs=None):
        ...
        """
        super(FweRuleBook, self).__init__()
    ...
    def add_rules(self, rule_defs):
        ...
        print self.rule_defs
        print self.resource_rules_map
